...
const Config = {
  'authorizationEndpoint': 'https://sso.connect.pingidentity.com/sso/as/authorization.oauth2',
...
const Home = () => (
  <div className="mt">
    <h1>Demo - React.js App1 OIDC Implicit Flow in PingOne</h1>
    <p>
      This page is unprotected by PingOne.
    </p>
  </div>
);
